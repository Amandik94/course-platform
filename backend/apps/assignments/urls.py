...
from .views import (
    AssignmentDetailView, SubmitAssignmentView, AssignmentSubmissionsListView,
    SubmissionReviewView, AssignmentCreateView, AssignmentUpdateView, MySubmissionView,
)
...
urlpatterns = [
    ...
    path('assignments/<int:id>/my-submission/', MySubmissionView.as_view(), name='assignment-my-submission'),
